...
if(isset($_POST['login'])) 
  {
    ...
    $sql ="SELECT ID FROM tbladmin WHERE NomUtilisateur=:username and MotDePasse=:password";
...
<html lang="en">
  <head>
    ...
    <title>Gestion(PFE) ISET Radès|| Login Page</title>
    <!-- plugins:css -->
          ...
          <div class="row flex-grow">
            <div class="col-lg-4 mx-auto">
              <div class="auth-form-light text-left p-5">
                ...
                <h6 class="font-weight-light">Connecter to continue.</h6>
