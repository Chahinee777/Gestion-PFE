...
$newpassword=md5($_POST['newpassword']);
  $sql ="SELECT Courriel FROM tbladmin WHERE Courriel=:email and NumeroMobile=:mobile";
...
if($query -> rowCount() > 0)
{
$con="update tbladmin set MotDePasse=:newpassword where Courriel=:email and NumeroMobile=:mobile";
          ...
          <div class="row flex-grow">
            <div class="col-lg-4 mx-auto">
              <div class="auth-form-light text-left p-5">
                ...
                <h4>Restaurer MotDePasse</h4>
                <h6 class="font-weight-light">Entrer votre Email et NumeroMobile pour Restaurer le MotDePasse</h6>
                <form class="pt-3" id="login" method="post" name="login">
                  ...
                  <div class="mb-2">
                    <a href="../index.php" class="btn btn-block btn-facebook auth-form-btn">
                      <i class="icon-social-home mr-2"></i>Rentrer à l'acceuil</a>
                  </div>
