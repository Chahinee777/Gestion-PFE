...
<html lang="en">
  <head>
    ...
    <title>Gestion(PFE) ISET Radès || Gérer Classes</title>
    <!-- plugins:css -->
        ...
        <div class="main-panel">
          <div class="content-wrapper">
             <div class="page-header">
              <h3 class="page-title"> Gérer Classes</h3>
              <nav aria-label="breadcrumb">
                <ol class="breadcrumb">
                  <li class="breadcrumb-item"><a href="dashboard.php">Dashboard</a></li>
                  <li class="breadcrumb-item active" aria-current="page"> Gérer Classes</li>
                </ol>
              </nav>
            </div>
            <div class="row">
                ...
                <div class="card">
                  <div class="card-body">
                    <div class="d-sm-flex align-items-center mb-4">
                      <h4 class="card-title mb-sm-0">Gérer Classes</h4>
                      <a href="#" class="text-dark ml-auto mb-3 mb-sm-0"> Voir tous Classes</a>
                    </div>
                      ...
                      <table class="table">
                        <thead>
                          <tr>
                            ...
                            <th class="font-weight-bold">Nom Classe</th>
                            <th class="font-weight-bold">Section</th>
                            <th class="font-weight-bold">Date de Creation</th>
