...
$sql="update tblclass set NomClasse=:cname,Section=:section where ID=:eid";
          ...
          <div class="content-wrapper">
            ...
            <div class="row">
              ...
              <div class="col-12 grid-margin stretch-card">
                <div class="card">
                  <div class="card-body">
                    <h4 class="card-title" style="text-align: center;"> Gérer Classes</h4>
...
{               ?>  
                      <div class="form-group">
                        ...
                        <input type="text" name="cname" value="<?php  echo htmlentities($row->NomClasse);?>" class="form-control" required='true'>
                      </div>
                      <div class="form-group">
