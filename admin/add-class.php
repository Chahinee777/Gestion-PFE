...
$sql="insert into tblclass(NomClasse,Section)values(:cname,:section)";
...
<html lang="en">
  <head>
    ...
    <title>Gestion(PFE) ISET Radès|| Ajouter Classe</title>
    <!-- plugins:css -->
          ...
          <div class="content-wrapper">
            ...
            <div class="row">
              ...
              <div class="col-12 grid-margin stretch-card">
                <div class="card">
                  <div class="card-body">
                    <h4 class="card-title" style="text-align: center;">Ajouter Classe</h4>
                   
                    <form class="forms-sample" method="post">
                      
                      <div class="form-group">
                        <label for="exampleInputName1">Nom de Classe</label>
