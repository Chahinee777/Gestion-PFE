...
if(isset($_POST['submit'])) {
    ...
    $sql = "SELECT CourrielEnseignant FROM tblenseignant WHERE CourrielEnseignant=:email AND NumeroContact=:mobile";
    ...
    if($query->rowCount() > 0) {
        $con = "UPDATE tblenseignant SET MotDePasse=:newpassword WHERE CourrielEnseignant=:email AND NumeroContact=:mobile";
...
<html lang="en">
  <head>
    ...
    <title>Gestion (PFE) ISET Radès || Mot de Passe Oublié</title>
    <!-- plugins:css -->
          ...
          <div class="row flex-grow">
            <div class="col-lg-4 mx-auto">
              <div class="auth-form-light text-left p-5">
                ...
                <h4>RECUPERER LE MOT DE PASSE</h4>
                <h6 class="font-weight-light">Entrer votre email ou CIN pour recuperer le mot de passe</h6>
                <form class="pt-3" id="login" method="post" name="login">
                  ...
                  <div class="mb-2">
                    <a href="../index.php" class="btn btn-block btn-facebook auth-form-btn">
                      <i class="icon-social-home mr-2"></i>Retourner a l'acceuil </a>
                  </div>
