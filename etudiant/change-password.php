...
$sql ="SELECT IDEtudiant FROM tbletudiant WHERE IDEtudiant=:sid and Password=:cpassword";
...
if($query -> rowCount() > 0)
{
$con="update tbletudiant set MotdePasse=:newpassword where IDEtudiant=:sid";
...
<html lang="en">
  <head>
    ...
    <title>Gestion(PFE) ISET Radès || Etudiant Changer Mot de Passe</title>
    <!-- plugins:css -->
